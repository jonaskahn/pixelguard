...
class TestBuildResult:
    """Test suite for the build_result function."""
    ...
    def test_build_result_with_successful_analysis(self, mock_analysis_result):
        ...
        # When
        result = build_result(file_name, url, analysis)
    ...
    def test_build_result_with_error(self):
        ...
        # When
        result = build_result(file_name, url, None, error=error)
...
class TestDownloadImage:
    """Test suite for the download_image function."""
    ...
    async def test_download_image_success(self):
        ...
        # When
        with patch("tests.test_server.download_image") as mock_download:
            mock_download.return_value = ("/tmp/test_image.png", None)

            file_path, error = await download_image(url)
...
async def test_health_endpoint(client):
    ...
    assert response.text == "API is running!!!"
